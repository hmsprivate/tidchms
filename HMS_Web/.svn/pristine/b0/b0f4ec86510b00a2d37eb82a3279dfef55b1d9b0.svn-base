            ...
            function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout, $window, $controller, $injector) {
                ...
                var publicMethods = {
                    ...
                    open: function (opts) {
                        ...
                        var templateId = 'templateId' + localID;
                        ...
                        $q.all({
                            ...
                            var content = $('<div class="ngdialog-content" role="document"></div>');
                            var temp = $(template);
                            temp.attr("id", templateId);
                            ...
                            $timeout(function () {
                                ...
                                /* [troi] 1.0 에 맞춰 수정 */                                                                
                                // -- 라이브러리 수정 시작
                                content.css("height", $("#" + templateId).css("height"));
                                content.css("width", $("#" + templateId).css("width"));   
                                
                                $("#" + templateId).draggable({
                                    containment:$("body"),
                                    handle: ".pop-header"
                                });
                                // -- 라이브러리 수정 종료
